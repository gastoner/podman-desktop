...
} from '/@api/dashboard-info.js';
import type { ProviderConnectionInfo, ProviderInfo } from '/@api/provider-info.js';
...
export class DashboardService {
  ...
  private updateSystemOverviewStatusBar(statusInfo: SystemOverviewStatusInfo): void {
    if (statusInfo.status === CRITICAL_STATUS && this.isEnhancedDashboardEnabled) {
